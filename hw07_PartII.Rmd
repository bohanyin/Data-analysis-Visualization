...
Checing from P-value, we found that degree, political identification as extreme conservative, being socially conservative, coming from South and tolerance are significant variables we should consider.  In particular, there are several variables that influence the attitude at a higher degree:
